...
var popUpCal = {
	...
	selectDate: function(Input) {
		...
		if (this.timeSeparators && this.timeSeparators.length > 1) Input.val(this.formatDate(this.selectedYear,this.selectedMonth,this.selectedDay,   this.selectedHour, this.selectedMinute));
	...
	setupActions: function() {
		if (this.timeSeparators && this.timeSeparators.length > 1) {
			$('#calendar_hour').change(function() {	//change hour
				...
				popUpCal.adjustDate(); 
				popUpCal.input.val(popUpCal.formatDate(popUpCal.selectedYear,popUpCal.selectedMonth,popUpCal.selectedDay,   popUpCal.selectedHour, popUpCal.selectedMinute));
