...
<div id="content">
  <div id="post">
      <div id="view">
        <div id="addRecord"> Add Crop  Pest </div>
        <?php
      if($action=='success')
{
	?>
...
<table width="100%" cellpadding="5" cellspacing="1">
          ...
          <tr id="entityRowOdd">
            ...
            <td><label for="pest">
              <select name="pest" id="pest">
                <?php  
			$cropList=entity::fetchEntityList('pests');
         ...
         <tr id="entityRowEven">
            <td>Control</td>
            <td><textarea name="control" cols="42" rows="3" id="control" $description="$description"><?php if($action=='update'){echo $description;} ?>
            </textarea></td>
          </tr>
          <tr bgcolor="#96CA1D">
            <td>&nbsp;</td>
