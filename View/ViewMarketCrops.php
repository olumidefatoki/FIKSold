...
if (isset($_SESSION['menuName']) or isset($_GET['recID']) && isset($_SESSION['username'])) {
    ...
    $_SESSION['menuTableName']='marketcrop';
    $_SESSION['menuName']='marketcrop';
    ...
    if (!isset($_SESSION['query'])) {
      ...
      $Marketlist = entity::populateMarketCrop($marketID,$startpoint, $limit);
    ...
    ?>
                        ...
                        <div id="view">
                            <div style="color:#044407; font-size:28px; margin-top:2px ; margin-bottom:10px;">View <?php echo $marketName; ?>  Market Crops</div>
