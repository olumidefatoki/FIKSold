...
<div id="wrapper">
  ...
  <div id="Navigation"><?php include 'navigation.php'; ?></div>
            <div id="content">
              <div id="post">
                <div id="view">
            <div style="color:#044407; font-size:28px; margin-top:2px ; margin-bottom:10px;">MANAGE BROADCAST</div>
                        <?php
                        if (isset($errorlist)) {
                                    ...
                                    <tr>
                                        ...
                                        <td width="69%"><select name="season" id="season"  style="width:200px;" >
                                          ...
                                          <option value="animal" selected>ANIMAL</option>
                                                    ...
                                                    <tr><td colspan="2" align="center">  <input type="submit" value="Next" name="NextBroadcast" id="NextBroadcast" /></td>
                                                    </tr>
                              </table>
                          </form>
                  </div>
