        ...
        <div id="wrapper">
            ...
            <div id="content">
                <div id="post">
                    <div id="view">
                        <div id="addRecord">
                            Schedule New Broadcast for Vegatable</div>
<?php
if (isset($errorlist)) {
...
?>
                                ...
                                <tr id="entityRowEven">
                                    ...
                                    <td><select name="animal" id="animal" style="width:250px;">
                                      ...
                                      <?php
                                        $cropList = entity::fetchEntityList('vegetable');
                                ...
                                <tr bgcolor="#96CA1D" id="">
                                    <td colspan="2" align="right"><input name="BroadcastVegatable" type="submit" id="BroadcastVegatable"  value="Broadcast"  /> &nbsp;&nbsp;&nbsp;</td>
                                </tr>
                            </table>
