          ...
          <table width="100%" border="0" cellpadding="3"  class="recordTable">
            ...
            <tr id="entityRowEven">
              ...
              <td><label for="gender"></label>
                <textarea name="soil" cols="60" rows="5" id="soil"><?php if($action=='update'){echo $SiteSelection;} ?>
              </textarea></td>
            </tr>
            <tr id="entityRowOdd">
              <td><p>Season and Seed Rate</p></td>
              <td><span >
                <textarea name="seedRate" cols="60" rows="5" id="seedRate"><?php if($action=='update'){echo $HousingEquipment;} ?>
              </textarea>
              </span></td>
            </tr>
            <tr id="entityRowEven">
              <td><p>Varieties</p></td>
              <td><textarea name="variety" cols="60" rows="5" id="variety" $description="$description"><?php if($action=='update'){echo $BreedsBreeding;} ?>
            </textarea></td>
            </tr>
            <tr bgcolor="#96CA1D" id="entityRowOdd">
              <td><p>Spacing</p></td>
              <td><textarea name="spacing" cols="60" rows="5" id="spacing"><?php if($action=='update'){echo $PigManagement;} ?>
              </textarea></td>
            </tr>
            <tr id="entityRowEven">
              <td><p>Nutrient Management</p></td>
              <td><textarea name="nutrientMag" cols="60" rows="5" id="nutrientMag" $description="$description"><?php if($action=='update'){echo $FeedsFeeding;} ?>
            </textarea></td>
            </tr>
            <tr id="entityRowOdd">
              <td><p>Pest Management</p></td>
              <td><textarea name="pestMag" cols="60" rows="5" id="pestMag" $description="$description"><?php if($action=='update'){echo $HealthManagement;} ?>
            </textarea></td>
            </tr>
            <tr id="entityRowOdd">
              <td><p>Disease Management</p></td>
              <td><textarea name="diseaseMag" cols="60" rows="5" id="diseaseMag"><?php if($action=='update'){echo $Processing;} ?>
              </textarea></td>
            </tr>
            <tr id="entityRowEven">
              <td><p>Harvest and Yield</p></td>
              <td><textarea name="yield" cols="60" rows="5" id="yield" $description="$description"><?php if($action=='update'){echo $Marketing;} ?>
            </textarea></td>
            </tr>
            <tr bgcolor="#96CA1D" id="entityRowOdd">
              <td>&nbsp;</td>
