...
for ($i = 0; $i < $stateRows; $i++) {
    ...
    ?>
          ...
          <tr bgcolor="#96CA1D" id="entityRowOdd">
            ...
            ?>
            <div id="fcaloading"> <img src="../images/ajax-loader2.gif" alt=""/> Loading </div>
            </td>
          </tr>
          <tr bgcolor="#96CA1D" id="entityRowEven">
            <td width="242"> FUG Name</td>
            <td width="405"><label for="fugName"></label>
              <input name="fugName" class="inputControl" type="text" id="fugName"  value="<?php if($action=='update'){echo $Name;} ?>"/>
              <input type="hidden" name="fugID" id="fugID" value="<?php if($action=='update'){echo $ID;} ?>" />
             <?php
                                                 if (isset($errorlist)) {
                                                foreach ($errorlist as $value) {
          ...
          <tr bgcolor="#96CA1D" id="entityRowOdd">
            ...
            <td><label for="fugName"></label>
              <input name="fugLeaderName" class="inputControl" type="text" id="fugLeaderName"  value="<?php if($action=='update'){echo $groupLeadName;} ?>"/>
            <?php
                                                 if (isset($errorlist)) {
                                                foreach ($errorlist as $value) {
                                                    
                                                    if ($value=='fugLeaderName') {
          ...
          <tr id="entityRowEven">
            ...
            <td>            
              <input name="fugLeaderPhoneNo"  class="inputControl" type="text" id="fugLeaderPhoneNo"  value="<?php if($action=='update'){echo $groupLeadPhone;} ?>"/>
            <?php
                                                 if (isset($errorlist)) {
                                                foreach ($errorlist as $value) {
                                                    
                                                    if ($value=='fugLeaderPhoneNo') {
          ...
          <tr bgcolor="#96CA1D" id="entityRowOdd">
            <td colspan="2" align="right"><input type="submit"  class="addUpdateButton" name="<?php echo $action; ?>" id="<?php echo $action; ?>" value="<?php echo $action; ?>"  /></td>
            </tr>
        </table>
