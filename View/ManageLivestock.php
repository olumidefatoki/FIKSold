...
<table width="100%" cellpadding="5" cellspacing="1" class="recordTable">
          ...
          <tr bgcolor="#96CA1D" id="entityRowOdd">
            <td width="28%"> Name</td>
            <td width="72%"><label for="name"></label>
          ...
          <tr id="entityRowOdd">
            <td colspan="2" align="right"><input name="<?php echo $action; ?>" type="submit" class="addUpdateButton" id="<?php echo $action; ?>"   value="<?php echo $action; ?>"/></td>
            </tr>
        </table>
