...
<table width="100%" border="0" cellpadding="3"  class="recordTable">
         ...
         <tr bgcolor="#96CA1D" id="entityRowEven">
          ...
          <tr id="entityRowOdd">
            <td>Animal Health </td>
            <td>
              <textarea name="AnimalHealth" cols="50" rows="5" id="AnimalHealth"><?php if($action=='update'){echo $seedRate;} ?>
              </textarea></td>
          </tr>
          <tr id="entityRowEven">
            <td>Disease Managemet</td>
            <td><label for="gender"></label>
              <textarea name="DiseaseManagemet" cols="50" rows="5" id="DiseaseManagemet"><?php if($action=='update'){echo $seedRate;} ?>
              </textarea></td>
          </tr>
          <tr id="entityRowOdd">
            <td>Sickness</td>
