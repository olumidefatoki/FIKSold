...
if(isset($_SESSION['menuName']) or isset($_GET['actionSuccessfull']) && isset($_SESSION['username']))
{
    ...
    $_SESSION['menuTableName']='animalhusbandry';
    $menuTableName= $_SESSION['menuTableName'];
    $menuName=$_SESSION['menuName'];
//     echo "kjlhk". $menuName;
    $menuName=entity::animalHusCategory($menuName);
	//fectch all the record for a table
   $page = (int) (!isset($_GET["page"]) ? 1 : $_GET["page"]);
   $startpoint = ($page * $limit) - $limit;
    if (!isset($_SESSION['query'])) {
    $list=  entity::fetchAnimal($menuTableName,$startpoint,$limit,$menuName);
...
<div id="content">
  <div id="post">
      <div id="view">
        <div style="color:#044407; font-size:28px; margin-top:2px ; margin-bottom:10px;"><?php echo $menuName;  ?><br />
