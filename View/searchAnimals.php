...
elseif (isset($_SESSION['menuName'])  && isset($_SESSION['username']) && isset($_GET['ViewRecord'])) {
	$displayUpdate=false;
    $username=$_SESSION['username'];
    $displayTitle=false;
	$recID=$_GET['ViewRecord'];
        ...
        $result=entity::fetchRecord('animalhusbandry', $recID);
  ...
  foreach ($rolesList as $value) {
		...
		if($displayUpdate==true){
		   ...
		   echo "</li>";
                ...
                <div id="view">
                        <div style="color:#044407; font-size:28px; margin-top:2px ; margin-bottom:10px;">View  <?php  echo $menuName; ?>
                        ...
                        ?>
                  <div id="SearchHolder">
                            <form id="form1" name="form1" method="post" action="searchAnimals.php">
                                <table width="100%" cellpadding="5">
                                    <tr>
                                            <td width="25%"> Name</td>
                                            <td width="75%"><?php  echo $menuName; ?>
