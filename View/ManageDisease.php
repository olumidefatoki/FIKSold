...
<table width="100%" cellpadding="3" cellspacing="1">
          ...
          <tr bgcolor="#96CA1D" id="entityRowOdd">
            <td width="130"> <strong>Disease Name</strong></td>
          ...
          <tr id="entityRowEven">
            <td><strong>Affected Crop </strong></td>
            <td><textarea name="affectedCrop" cols="40" id="affectedCrop" $description="$description"><?php if($action=='update'){echo $description;} ?>
            </textarea></td>
          </tr>
          <tr id="entityRowOdd">
            <td><strong>Treatment </strong></td>
            <td><textarea name="treatment" cols="40" id="treatment" $description="$description"><?php if($action=='update'){echo $description;} ?>
            </textarea></td>
          </tr>
         Treatment
